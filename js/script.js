...
*/
      ...
      function populateInfoWindow(marker, infowindow) {
        ...
        if (infowindow.marker != marker) {
          ...
          infowindow.setContent('<div>' + marker.title + '</div>' + '<div><strong>Year Established: </strong>' + parks[marker.id].year + '</div>' + '<div><strong>Size: </strong>' + parks[marker.id].size + ' ha</div>');
